...
<head>
	...
	<title> Partners | <?php echo $userdata[0]['s_name'];?></title>
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<?php if(!empty($partners)) :?>
							<div class="panel-heading">Current Partners</div>
								...
								<div id="education_fields">
									...
									<div class="col-sm-5 nopadding" style="padding-left:20%">
										<table  align="center" class="table table-condensed table-bordered table-striped " >
											...
											<?php echo form_open('Partners/remove');?>
											<?php foreach($partners as $row):?>
												<?php echo '<tr>'; ?>
												<?php echo '<td>'.$row->gp_name .'</td>';?>
												<td style="width:1px"><button type="submit" name="remove" value="<?php echo $row->gp_id;?>" class="btn btn-danger">×</button></td>
												<?php echo '</tr>'; ?>
											<?php endforeach ; ?>
